      ...
      <div className="preference-box">
        <div className="per-head">
          ...
          <img
            className="App-logo"
            alt="background"
            src="https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-859.jpg?size=626&ext=jpg&ga=GA1.1.388351199.1701500805&semt=sph"
          />
        ...
        <div className="pre-buttons">
          <button
            ...
            onClick={() => handleMenuItemClick("PersonalInformation")}
          >
            Personal Information
          </button>
          <button
            className="pre-button"
            onClick={() => handleMenuItemClick("FamilyPreferences")}
          >
            Family Preferences
          </button>
          <button
            className="pre-button"
            onClick={() => handleMenuItemClick("PartnerPreferences")}
          >
            Partner Preferences
          </button>
